...
The deployment url is: [https://pglez82.github.io/asw2324_0/](https://pglez82.github.io/asw2324_0/).
...
If we want to deploy it to GitHub pages, so it is accessible via [https://pglez82.github.io/asw2324_0/](https://pglez82.github.io/asw2324_0/), we need to execute `npm run deploy`.
